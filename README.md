...
|---------|-----------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| Val-001 | Data model provisioning                                               | This test case aims at validating the successful creation of entities and devices. This is the basis of nearly all applications. For a realistic scenario, consider the devices and datapoints to be available in an excel sheet.                                                                                                                                                                                                                                                                           | Implemented    |
| Val-002 | Subscriptions on historic data                                        | This test case aims at validating the successful creation of a subscription on live data to be notified to QuantumLeap in order to store them as historic data in the timeseries database.                                                                                                                                                                                                                                                                                                                  | Implemented    |
| Val-003 | Subscription deactivation and activation                              | This test case aims at validating a successful deactivation and reactivation of subscriptions from the Orion contextbroker to notify QuantumLeap. Validate that no data is forwarded once subscriptions are deactivated and continue when reactivated.                                                                                                                                                                                                                                                      |                |
| Val-004 | Open-Loop control                                                     | Open-Loop control is useful for creating training data for system identification/model training. It involves controlling manipulated variables without feedback on control loop; command issued on actuator device processed with feedback signal stored in timeseries database along with other state variables from sensors capturing system reaction after actuation.                                                                                                                                    |                |
| Val-006 | Closed-Loop control                                                   | Similar to Val-004 but with feedback on the control loop using a simulation model combined with PID controller.                                                                                                                                                                                                                                                                                                                                                                                             |                |
| Val-007 | Autoprovision                                                         | Autoprovisioning functionality provided by GE IoTagents allows anonymous sensors knowing API-Key to provision themselves upon sending first data.                                                                                                                                                                                                                                                                                                                                                           |                |
| Val-008 | Notification for forwarding control signal/data to external endpoints | Orion Context Broker provides possibilities to notify external endpoints, including custom notifications used for forwarding control signals.                                                                                                                                                                                                                                                                                                                                                               | Implemented    |
| Val-009 | Multi Entity                                                          | IoTagent allows forwarding data not only on device level but also attribute's level; attributes can be mapped with different context entities or multiple attributes using "expression".                                                                                                                                                                                                                                                                                                                    |                |
| Val-010 | Entity Update                                                         | Different use cases require best ways to update entities: single/multiple values or attributes, add/delete attributes, update metadata etc.                                                                                                                                                                                                                                                                                                                                                                 | Implemented    |
| Val-011 | Command Acknowledgement                                               | This testcase aims at validating the acknowledgement mechanism acknowledging an incoming command for a field device. This mechanism is useful to verify a command has successfully been transferred to the field an there is no communication error present.                                                                                                                                                                                                                                                |                |
| Val-012 | Update entity based on incoming MQTT message via IoT Agent            | This testcase is a prerequisite to all testcases using the IoT Agent forwarding data to the Orion contextbroker. <br/><br/>For instance, consider cases if explicit attributes are allowed/forced or not, where the behavior may vary, e.g. accepting incoming MQTT messages only on specific topics. Currently, three scenarios are identified: <br/>1. Autoprovision with service group; <br/>2. Cross-group update with different entity types; <br/>3. Importance of `transport` in device provisioning | Under progress |
